...
|--------|-------------|----------|
| [pogopin-mcp](https://github.com/dangernoodle-io/pogopin/tree/main/plugin) | Embedded development MCP server — serial monitoring, ESP-IDF flashing, NVS management, and crash decode. | [pogopin](https://github.com/dangernoodle-io/pogopin) |
